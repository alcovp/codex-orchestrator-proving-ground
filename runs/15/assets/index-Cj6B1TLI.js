...
`)}const sm={[Ol]:"Linear",[Bl]:"Reinhard",[zl]:"Cineon",[Vl]:"ACESFilmic",[Hl]:"AgX",[kl]:"Neutral",[Gl]:"Custom"};function rm(r,e){const t=sm[e];return t===void 0?(Ue("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ns=new k;function om(){$e.getLuminanceCoefficients(Ns);const r=Ns.x.toFixed(4),e=Ns.y.toFixed(4),t=Ns.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+f);const E=x+m+o,y=x+f+a,b=rl(i,i.VERTEX_SHADER,E),A=rl(i,i.FRAGMENT_SHADER,y);i.attachShader(_,b),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(P){if(r.debug.checkShaderErrors){const V=i.getProgramInfoLog(_)||"",L=i.getShaderInfoLog(b)||"",B=i.getShaderInfoLog(A)||"",F=V.trim(),I=L.trim(),G=B.trim();let X=!0,K=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(X=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,b,A);else{const se=al(i,b,"vertex"),te=al(i,A,"fragment");Ze("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`,Vm=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],Gm=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],ml=new ut,Yi=new k,zr=new k;function Hm(r,e,t){let n=new ea;const i=new et,s=new et,o=new pt,a=new Jh,l=new Qh,c={},h=t.maxTextureSize,d={[Xn]:zt,[zt]:Xn,[Pn]:Pn},u=new xn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new et},radius:{value:4}},vertexShader:Bm,fragmentShader:zm}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const g=new Kt;g.setAttribute("position",new mn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Bt(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Vs;let f=this.type;this.render=function(A,R,U){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;A.type===Ul&&(Ue("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),A.type=Vs);const M=r.getRenderTarget(),w=r.getActiveCubeFace(),P=r.getActiveMipmapLevel(),V=r.state;V.setBlending(In),V.buffers.depth.getReversed()===!0?V.buffers.color.setClear(0,0,0,0):V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);const L=f!==this.type;L&&R.traverse(function(B){B.material&&(Array.isArray(B.material)?B.material.forEach(F=>F.needsUpdate=!0):B.material.needsUpdate=!0)});for(let B=0,F=A.length;B<F;B++){const I=A[B],G=I.shadow;if(G===void 0){Ue("WebGLShadowMap:",I,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;i.copy(G.mapSize);const X=G.getFrameExtents();if(i.multiply(X),s.copy(G.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/X.x),i.x=s.x*X.x,G.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/X.y),i.y=s.y*X.y,G.mapSize.y=s.y)),G.map===null||L===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Ji){if(I.isPointLight){Ue("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new pn(i.x,i.y,{format:Pi,type:Nn,minFilter:Et,magFilter:Et,generateMipmaps:!1}),G.map.texture.name=I.name+".shadowMap",G.map.depthTexture=new ss(i.x,i.y,un),G.map.depthTexture.name=I.name+".shadowMapDepth",G.map.depthTexture.format=Un,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=At,G.map.depthTexture.magFilter=At}else{I.isPointLight?(G.map=new cc(i.x),G.map.depthTexture=new Kh(i.x,gn)):(G.map=new pn(i.x,i.y),G.map.depthTexture=new ss(i.x,i.y,gn)),G.map.depthTexture.name=I.name+".shadowMap",G.map.depthTexture.format=Un;const se=r.state.buffers.depth.getReversed();this.type===Vs?(G.map.depthTexture.compareFunction=se?Zo:Ko,G.map.depthTexture.minFilter=Et,G.map.depthTexture.magFilter=Et):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=At,G.map.depthTexture.magFilter=At)}G.camera.updateProjectionMatrix()}const K=G.map.isWebGLCubeRenderTarget?6:1;for(let se=0;se<K;se++){if(G.map.isWebGLCubeRenderTarget)r.setRenderTarget(G.map,se),r.clear();else{se===0&&(r.setRenderTarget(G.map),r.clear());const te=G.getViewport(se);o.set(s.x*te.x,s.y*te.y,s.x*te.z,s.y*te.w),V.viewport(o)}if(I.isPointLight){const te=G.camera,oe=G.matrix,Ie=I.distance||te.far;Ie!==te.far&&(te.far=Ie,te.updateProjectionMatrix()),Yi.setFromMatrixPosition(I.matrixWorld),te.position.copy(Yi),zr.copy(te.position),zr.add(Vm[se]),te.up.copy(Gm[se]),te.lookAt(zr),te.updateMatrixWorld(),oe.makeTranslation(-Yi.x,-Yi.y,-Yi.z),ml.multiplyMatrices(te.projectionMatrix,te.matrixWorldInverse),G._frustum.setFromProjectionMatrix(ml,te.coordinateSystem,te.reversedDepth)}else G.updateMatrices(I);n=G.getFrustum(),y(R,U,G.camera,I,this.type)}G.isPointLightShadow!==!0&&this.type===Ji&&x(G,U),G.needsUpdate=!1}f=this.type,m.needsUpdate=!1,r.setRenderTarget(M,w,P)};function x(A,R){const U=e.update(_);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new pn(i.x,i.y,{format:Pi,type:Nn})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,r.setRenderTarget(A.mapPass),r.clear(),r.renderBufferDirect(R,null,U,u,_,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,r.setRenderTarget(A.map),r.clear(),r.renderBufferDirect(R,null,U,p,_,null)}function E(A,R,U,M){let w=null;const P=U.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(P!==void 0)w=P;else if(w=U.isPointLight===!0?l:a,r.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const V=w.uuid,L=R.uuid;let B=c[V];B===void 0&&(B={},c[V]=B);let F=B[L];F===void 0&&(F=w.clone(),B[L]=F,R.addEventListener("dispose",b)),w=F}if(w.visible=R.visible,w.wireframe=R.wireframe,M===Ji?w.side=R.shadowSide!==null?R.shadowSide:R.side:w.side=R.shadowSide!==null?R.shadowSide:d[R.side],w.alphaMap=R.alphaMap,w.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,w.map=R.map,w.clipShadows=R.clipShadows,w.clippingPlanes=R.clippingPlanes,w.clipIntersection=R.clipIntersection,w.displacementMap=R.displacementMap,w.displacementScale=R.displacementScale,w.displacementBias=R.displacementBias,w.wireframeLinewidth=R.wireframeLinewidth,w.linewidth=R.linewidth,U.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const V=r.properties.get(w);V.light=U}return w}function y(A,R,U,M,w){if(A.visible===!1)return;if(A.layers.test(R.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&w===Ji)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,A.matrixWorld);const L=e.update(A),B=A.material;if(Array.isArray(B)){const F=L.groups;for(let I=0,G=F.length;I<G;I++){const X=F[I],K=B[X.materialIndex];if(K&&K.visible){const se=E(A,K,M,w);A.onBeforeShadow(r,A,R,U,L,se,X),r.renderBufferDirect(U,null,L,se,A,X),A.onAfterShadow(r,A,R,U,L,se,X)}}}else if(B.visible){const F=E(A,B,M,w);A.onBeforeShadow(r,A,R,U,L,F,null),r.renderBufferDirect(U,null,L,F,A,null),A.onAfterShadow(r,A,R,U,L,F,null)}}const V=A.children;for(let L=0,B=V.length;L<B;L++)y(V[L],R,U,M,w)}function b(A){A.target.removeEventListener("dispose",b);for(const U in c){const M=c[U],w=A.target.uuid;w in M&&(M[w].dispose(),delete M[w])}}}const km={[Kr]:Zr,[Jr]:to,[Qr]:no,[Ci]:eo,[Zr]:Kr,[to]:Jr,[no]:Qr,[eo]:Ci};function Wm(r,e){function t(){let O=!1;const me=new pt;let ae=null;const xe=new pt(0,0,0,0);return{setMask:function(ie){ae!==ie&&!O&&(r.colorMask(ie,ie,ie,ie),ae=ie)},setLocked:function(ie){O=ie},setClear:function(ie,J,le,Fe,at){at===!0&&(ie*=Fe,J*=Fe,le*=Fe),me.set(ie,J,le,Fe),xe.equals(me)===!1&&(r.clearColor(ie,J,le,Fe),xe.copy(me))},reset:function(){O=!1,ae=null,xe.set(-1,0,0,0)}}}function n(){let O=!1,me=!1,ae=null,xe=null,ie=null;return{setReversed:function(J){if(me!==J){const le=e.get("EXT_clip_control");J?le.clipControlEXT(le.LOWER_LEFT_EXT,le.ZERO_TO_ONE_EXT):le.clipControlEXT(le.LOWER_LEFT_EXT,le.NEGATIVE_ONE_TO_ONE_EXT),me=J;const Fe=ie;ie=null,this.setClear(Fe)}},getReversed:function(){return me},setTest:function(J){J?Q(r.DEPTH_TEST):Me(r.DEPTH_TEST)},setMask:function(J){ae!==J&&!O&&(r.depthMask(J),ae=J)},setFunc:function(J){if(me&&(J=km[J]),xe!==J){switch(J){case Kr:r.depthFunc(r.NEVER);break;case Zr:r.depthFunc(r.ALWAYS);break;case Jr:r.depthFunc(r.LESS);break;case Ci:r.depthFunc(r.LEQUAL);break;case Qr:r.depthFunc(r.EQUAL);break;case eo:r.depthFunc(r.GEQUAL);break;case to:r.depthFunc(r.GREATER);break;case no:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}xe=J}},setLocked:function(J){O=J},setClear:function(J){ie!==J&&(me&&(J=1-J),r.clearDepth(J),ie=J)},reset:function(){O=!1,ae=null,xe=null,ie=null,me=!1}}}function i(){let O=!1,me=null,ae=null,xe=null,ie=null,J=null,le=null,Fe=null,at=null;return{setTest:function(nt){O||(nt?Q(r.STENCIL_TEST):Me(r.STENCIL_TEST))},setMask:function(nt){me!==nt&&!O&&(r.stencilMask(nt),me=nt)},setFunc:function(nt,rn,vn){(ae!==nt||xe!==rn||ie!==vn)&&(r.stencilFunc(nt,rn,vn),ae=nt,xe=rn,ie=vn)},setOp:function(nt,rn,vn){(J!==nt||le!==rn||Fe!==vn)&&(r.stencilOp(nt,rn,vn),J=nt,le=rn,Fe=vn)},setLocked:function(nt){O=nt},setClear:function(nt){at!==nt&&(r.clearStencil(nt),at=nt)},reset:function(){O=!1,me=null,ae=null,xe=null,ie=null,J=null,le=null,Fe=null,at=null}}}const s=new t,o=new n,a=new i,l=new WeakMap,c=new WeakMap;let h={},d={},u=new WeakMap,p=[],g=null,_=!1,m=null,f=null,x=null,E=null,y=null,b=null,A=null,R=new ke(0,0,0),U=0,M=!1,w=null,P=null,V=null,L=null,B=null;const F=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,G=0;const X=r.getParameter(r.VERSION);X.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(X)[1]),I=G>=1):X.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),I=G>=2);let K=null,se={};const te=r.getParameter(r.SCISSOR_BOX),oe=r.getParameter(r.VIEWPORT),Ie=new pt().fromArray(te),We=new pt().fromArray(oe);function je(O,me,ae,xe){const ie=new Uint8Array(4),J=r.createTexture();r.bindTexture(O,J),r.texParameteri(O,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(O,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let le=0;le<ae;le++)O===r.TEXTURE_3D||O===r.TEXTURE_2D_ARRAY?r.texImage3D(me,0,r.RGBA,1,1,xe,0,r.RGBA,r.UNSIGNED_BYTE,ie):r.texImage2D(me+le,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ie);return J}const $={};$[r.TEXTURE_2D]=je(r.TEXTURE_2D,r.TEXTURE_2D,1),$[r.TEXTURE_CUBE_MAP]=je(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),$[r.TEXTURE_2D_ARRAY]=je(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),$[r.TEXTURE_3D]=je(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Q(r.DEPTH_TEST),o.setFunc(Ci),Be(!1),ht(pa),Q(r.CULL_FACE),Je(In);function Q(O){h[O]!==!0&&(r.enable(O),h[O]=!0)}function Me(O){h[O]!==!1&&(r.disable(O),h[O]=!1)}function Oe(O,me){return d[O]!==me?(r.bindFramebuffer(O,me),d[O]=me,O===r.DRAW_FRAMEBUFFER&&(d[r.FRAMEBUFFER]=me),O===r.FRAMEBUFFER&&(d[r.DRAW_FRAMEBUFFER]=me),!0):!1}function Se(O,me){let ae=p,xe=!1;if(O){ae=u.get(me),ae===void 0&&(ae=[],u.set(me,ae));const ie=O.textures;if(ae.length!==ie.length||ae[0]!==r.COLOR_ATTACHMENT0){for(let J=0,le=ie.length;J<le;J++)ae[J]=r.COLOR_ATTACHMENT0+J;ae.length=ie.length,xe=!0}}else ae[0]!==r.BACK&&(ae[0]=r.BACK,xe=!0);xe&&r.drawBuffers(ae)}function Xe(O){return g!==O?(r.useProgram(O),g=O,!0):!1}const mt={[ni]:r.FUNC_ADD,[kc]:r.FUNC_SUBTRACT,[Wc]:r.FUNC_REVERSE_SUBTRACT};mt[Xc]=r.MIN,mt[qc]=r.MAX;const qe={[Yc]:r.ZERO,[jc]:r.ONE,[$c]:r.SRC_COLOR,[jr]:r.SRC_ALPHA,[th]:r.SRC_ALPHA_SATURATE,[Qc]:r.DST_COLOR,[Zc]:r.DST_ALPHA,[Kc]:r.ONE_MINUS_SRC_COLOR,[$r]:r.ONE_MINUS_SRC_ALPHA,[eh]:r.ONE_MINUS_DST_COLOR,[Jc]:r.ONE_MINUS_DST_ALPHA,[nh]:r.CONSTANT_COLOR,[ih]:r.ONE_MINUS_CONSTANT_COLOR,[sh]:r.CONSTANT_ALPHA,[rh]:r.ONE_MINUS_CONSTANT_ALPHA};function Je(O,me,ae,xe,ie,J,le,Fe,at,nt){if(O===In){_===!0&&(Me(r.BLEND),_=!1);return}if(_===!1&&(Q(r.BLEND),_=!0),O!==Hc){if(O!==m||nt!==M){if((f!==ni||y!==ni)&&(r.blendEquation(r.FUNC_ADD),f=ni,y=ni),nt)switch(O){case Ti:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case ma:r.blendFunc(r.ONE,r.ONE);break;case ga:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case _a:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:Ze("WebGLState: Invalid blending: ",O);break}else switch(O){case Ti:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case ma:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case ga:Ze("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case _a:Ze("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ze("WebGLState: Invalid blending: ",O);break}x=null,E=null,b=null,A=null,R.set(0,0,0),U=0,m=O,M=nt}return}ie=ie||me,J=J||ae,le=le||xe,(me!==f||ie!==y)&&(r.blendEquationSeparate(mt[me],mt[ie]),f=me,y=ie),(ae!==x||xe!==E||J!==b||le!==A)&&(r.blendFuncSeparate(qe[ae],qe[xe],qe[J],qe[le]),x=ae,E=xe,b=J,A=le),(Fe.equals(R)===!1||at!==U)&&(r.blendColor(Fe.r,Fe.g,Fe.b,at),R.copy(Fe),U=at),m=O,M=!1}function tt(O,me){O.side===Pn?Me(r.CULL_FACE):Q(r.CULL_FACE);let ae=O.side===zt;me&&(ae=!ae),Be(ae),O.blending===Ti&&O.transparent===!1?Je(In):Je(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),o.setFunc(O.depthFunc),o.setTest(O.depthTest),o.setMask(O.depthWrite),s.setMask(O.colorWrite);const xe=O.stencilWrite;a.setTest(xe),xe&&(a.setMask(O.stencilWriteMask),a.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),a.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),_e(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?Q(r.SAMPLE_ALPHA_TO_COVERAGE):Me(r.SAMPLE_ALPHA_TO_COVERAGE)}function Be(O){w!==O&&(O?r.frontFace(r.CW):r.frontFace(r.CCW),w=O)}function ht(O){O!==Vc?(Q(r.CULL_FACE),O!==P&&(O===pa?r.cullFace(r.BACK):O===Gc?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Me(r.CULL_FACE),P=O}function D(O){O!==V&&(I&&r.lineWidth(O),V=O)}function _e(O,me,ae){O?(Q(r.POLYGON_OFFSET_FILL),(L!==me||B!==ae)&&(r.polygonOffset(me,ae),L=me,B=ae)):Me(r.POLYGON_OFFSET_FILL)}function ne(O){O?Q(r.SCISSOR_TEST):Me(r.SCISSOR_TEST)}function ge(O){O===void 0&&(O=r.TEXTURE0+F-1),K!==O&&(r.activeTexture(O),K=O)}function ee(O,me,ae){ae===void 0&&(K===null?ae=r.TEXTURE0+F-1:ae=K);let xe=se[ae];xe===void 0&&(xe={type:void 0,texture:void 0},se[ae]=xe),(xe.type!==O||xe.texture!==me)&&(K!==ae&&(r.activeTexture(ae),K=ae),r.bindTexture(O,me||$[O]),xe.type=O,xe.texture=me)}function C(){const O=se[K];O!==void 0&&O.type!==void 0&&(r.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function v(){try{r.compressedTexImage2D(...arguments)}catch(O){Ze("WebGLState:",O)}}function N(){try{r.compressedTexImage3D(...arguments)}catch(O){Ze("WebGLState:",O)}}function j(){try{r.texSubImage2D(...arguments)}catch(O){Ze("WebGLState:",O)}}function Z(){try{r.texSubImage3D(...arguments)}catch(O){Ze("WebGLState:",O)}}function Y(){try{r.compressedTexSubImage2D(...arguments)}catch(O){Ze("WebGLState:",O)}}function Ce(){try{r.compressedTexSubImage3D(...arguments)}catch(O){Ze("WebGLState:",O)}}function ce(){try{r.texStorage2D(...arguments)}catch(O){Ze("WebGLState:",O)}}function Te(){try{r.texStorage3D(...arguments)}catch(O){Ze("WebGLState:",O)}}function Ne(){try{r.texImage2D(...arguments)}catch(O){Ze("WebGLState:",O)}}function re(){try{r.texImage3D(...arguments)}catch(O){Ze("WebGLState:",O)}}function ue(O){Ie.equals(O)===!1&&(r.scissor(O.x,O.y,O.z,O.w),Ie.copy(O))}function we(O){We.equals(O)===!1&&(r.viewport(O.x,O.y,O.z,O.w),We.copy(O))}function Ae(O,me){let ae=c.get(me);ae===void 0&&(ae=new WeakMap,c.set(me,ae));let xe=ae.get(O);xe===void 0&&(xe=r.getUniformBlockIndex(me,O.name),ae.set(O,xe))}function he(O,me){const xe=c.get(me).get(O);l.get(me)!==xe&&(r.uniformBlockBinding(me,xe,O.__bindingPointIndex),l.set(me,xe))}function Ge(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),o.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},K=null,se={},d={},u=new WeakMap,p=[],g=null,_=!1,m=null,f=null,x=null,E=null,y=null,b=null,A=null,R=new ke(0,0,0),U=0,M=!1,w=null,P=null,V=null,L=null,B=null,Ie.set(0,0,r.canvas.width,r.canvas.height),We.set(0,0,r.canvas.width,r.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:Q,disable:Me,bindFramebuffer:Oe,drawBuffers:Se,useProgram:Xe,setBlending:Je,setMaterial:tt,setFlipSided:Be,setCullFace:ht,setLineWidth:D,setPolygonOffset:_e,setScissorTest:ne,activeTexture:ge,bindTexture:ee,unbindTexture:C,compressedTexImage2D:v,compressedTexImage3D:N,texImage2D:Ne,texImage3D:re,updateUBOMapping:Ae,uniformBlockBinding:he,texStorage2D:ce,texStorage3D:Te,texSubImage2D:j,texSubImage3D:Z,compressedTexSubImage2D:Y,compressedTexSubImage3D:Ce,scissor:ue,viewport:we,reset:Ge}}function Xm(r,e,t,n,i,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new et,h=new WeakMap;let d;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(C,v){return p?new OffscreenCanvas(C,v):js("canvas")}function _(C,v,N){let j=1;const Z=ee(C);if((Z.width>N||Z.height>N)&&(j=N/Math.max(Z.width,Z.height)),j<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const Y=Math.floor(j*Z.width),Ce=Math.floor(j*Z.height);d===void 0&&(d=g(Y,Ce));const ce=v?g(Y,Ce):d;return ce.width=Y,ce.height=Ce,ce.getContext("2d").drawImage(C,0,0,Y,Ce),Ue("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+Y+"x"+Ce+")."),ce}else return"data"in C&&Ue("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),C;return C}function m(C){return C.generateMipmaps}function f(C){r.generateMipmap(C)}function x(C){return C.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?r.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function E(C,v,N,j,Z=!1){if(C!==null){if(r[C]!==void 0)return r[C];Ue("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let Y=v;if(v===r.RED&&(N===r.FLOAT&&(Y=r.R32F),N===r.HALF_FLOAT&&(Y=r.R16F),N===r.UNSIGNED_BYTE&&(Y=r.R8)),v===r.RED_INTEGER&&(N===r.UNSIGNED_BYTE&&(Y=r.R8UI),N===r.UNSIGNED_SHORT&&(Y=r.R16UI),N===r.UNSIGNED_INT&&(Y=r.R32UI),N===r.BYTE&&(Y=r.R8I),N===r.SHORT&&(Y=r.R16I),N===r.INT&&(Y=r.R32I)),v===r.RG&&(N===r.FLOAT&&(Y=r.RG32F),N===r.HALF_FLOAT&&(Y=r.RG16F),N===r.UNSIGNED_BYTE&&(Y=r.RG8)),v===r.RG_INTEGER&&(N===r.UNSIGNED_BYTE&&(Y=r.RG8UI),N===r.UNSIGNED_SHORT&&(Y=r.RG16UI),N===r.UNSIGNED_INT&&(Y=r.RG32UI),N===r.BYTE&&(Y=r.RG8I),N===r.SHORT&&(Y=r.RG16I),N===r.INT&&(Y=r.RG32I)),v===r.RGB_INTEGER&&(N===r.UNSIGNED_BYTE&&(Y=r.RGB8UI),N===r.UNSIGNED_SHORT&&(Y=r.RGB16UI),N===r.UNSIGNED_INT&&(Y=r.RGB32UI),N===r.BYTE&&(Y=r.RGB8I),N===r.SHORT&&(Y=r.RGB16I),N===r.INT&&(Y=r.RGB32I)),v===r.RGBA_INTEGER&&(N===r.UNSIGNED_BYTE&&(Y=r.RGBA8UI),N===r.UNSIGNED_SHORT&&(Y=r.RGBA16UI),N===r.UNSIGNED_INT&&(Y=r.RGBA32UI),N===r.BYTE&&(Y=r.RGBA8I),N===r.SHORT&&(Y=r.RGBA16I),N===r.INT&&(Y=r.RGBA32I)),v===r.RGB&&(N===r.UNSIGNED_INT_5_9_9_9_REV&&(Y=r.RGB9_E5),N===r.UNSIGNED_INT_10F_11F_11F_REV&&(Y=r.R11F_G11F_B10F)),v===r.RGBA){const Ce=Z?qs:$e.getTransfer(j);N===r.FLOAT&&(Y=r.RGBA32F),N===r.HALF_FLOAT&&(Y=r.RGBA16F),N===r.UNSIGNED_BYTE&&(Y=Ce===st?r.SRGB8_ALPHA8:r.RGBA8),N===r.UNSIGNED_SHORT_4_4_4_4&&(Y=r.RGBA4),N===r.UNSIGNED_SHORT_5_5_5_1&&(Y=r.RGB5_A1)}return(Y===r.R16F||Y===r.R32F||Y===r.RG16F||Y===r.RG32F||Y===r.RGBA16F||Y===r.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function y(C,v){let N;return C?v===null||v===gn||v===ns?N=r.DEPTH24_STENCIL8:v===un?N=r.DEPTH32F_STENCIL8:v===ts&&(N=r.DEPTH24_STENCIL8,Ue("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===gn||v===ns?N=r.DEPTH_COMPONENT24:v===un?N=r.DEPTH_COMPONENT32F:v===ts&&(N=r.DEPTH_COMPONENT16),N}function b(C,v){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==At&&C.minFilter!==Et?Math.log2(Math.max(v.width,v.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?v.mipmaps.length:1}function A(C){const v=C.target;v.removeEventListener("dispose",A),U(v),v.isVideoTexture&&h.delete(v)}function R(C){const v=C.target;v.removeEventListener("dispose",R),w(v)}function U(C){const v=n.get(C);if(v.__webglInit===void 0)return;const N=C.source,j=u.get(N);if(j){const Z=j[v.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&M(C),Object.keys(j).length===0&&u.delete(N)}n.remove(C)}function M(C){const v=n.get(C);r.deleteTexture(v.__webglTexture);const N=C.source,j=u.get(N);delete j[v.__cacheKey],o.memory.textures--}function w(C){const v=n.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),n.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(v.__webglFramebuffer[j]))for(let Z=0;Z<v.__webglFramebuffer[j].length;Z++)r.deleteFramebuffer(v.__webglFramebuffer[j][Z]);else r.deleteFramebuffer(v.__webglFramebuffer[j]);v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer[j])}else{if(Array.isArray(v.__webglFramebuffer))for(let j=0;j<v.__webglFramebuffer.length;j++)r.deleteFramebuffer(v.__webglFramebuffer[j]);else r.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&r.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let j=0;j<v.__webglColorRenderbuffer.length;j++)v.__webglColorRenderbuffer[j]&&r.deleteRenderbuffer(v.__webglColorRenderbuffer[j]);v.__webglDepthRenderbuffer&&r.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const N=C.textures;for(let j=0,Z=N.length;j<Z;j++){const Y=n.get(N[j]);Y.__webglTexture&&(r.deleteTexture(Y.__webglTexture),o.memory.textures--),n.remove(N[j])}n.remove(C)}let P=0;function V(){P=0}function L(){const C=P;return C>=i.maxTextures&&Ue("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+i.maxTextures),P+=1,C}function B(C){const v=[];return v.push(C.wrapS),v.push(C.wrapT),v.push(C.wrapR||0),v.push(C.magFilter),v.push(C.minFilter),v.push(C.anisotropy),v.push(C.internalFormat),v.push(C.format),v.push(C.type),v.push(C.generateMipmaps),v.push(C.premultiplyAlpha),v.push(C.flipY),v.push(C.unpackAlignment),v.push(C.colorSpace),v.join()}function F(C,v){const N=n.get(C);if(C.isVideoTexture&&ne(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&N.__version!==C.version){const j=C.image;if(j===null)Ue("WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)Ue("WebGLRenderer: Texture marked for update but image is incomplete");else{$(N,C,v);return}}else C.isExternalTexture&&(N.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(r.TEXTURE_2D,N.__webglTexture,r.TEXTURE0+v)}function I(C,v){const N=n.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&N.__version!==C.version){$(N,C,v);return}else C.isExternalTexture&&(N.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(r.TEXTURE_2D_ARRAY,N.__webglTexture,r.TEXTURE0+v)}function G(C,v){const N=n.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&N.__version!==C.version){$(N,C,v);return}t.bindTexture(r.TEXTURE_3D,N.__webglTexture,r.TEXTURE0+v)}function X(C,v){const N=n.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&N.__version!==C.version){Q(N,C,v);return}t.bindTexture(r.TEXTURE_CUBE_MAP,N.__webglTexture,r.TEXTURE0+v)}const K={[ro]:r.REPEAT,[Ln]:r.CLAMP_TO_EDGE,[oo]:r.MIRRORED_REPEAT},se={[At]:r.NEAREST,[lh]:r.NEAREST_MIPMAP_NEAREST,[ds]:r.NEAREST_MIPMAP_LINEAR,[Et]:r.LINEAR,[ar]:r.LINEAR_MIPMAP_NEAREST,[ri]:r.LINEAR_MIPMAP_LINEAR},te={[uh]:r.NEVER,[gh]:r.ALWAYS,[dh]:r.LESS,[Ko]:r.LEQUAL,[fh]:r.EQUAL,[Zo]:r.GEQUAL,[ph]:r.GREATER,[mh]:r.NOTEQUAL};function oe(C,v){if(v.type===un&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Et||v.magFilter===ar||v.magFilter===ds||v.magFilter===ri||v.minFilter===Et||v.minFilter===ar||v.minFilter===ds||v.minFilter===ri)&&Ue("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(C,r.TEXTURE_WRAP_S,K[v.wrapS]),r.texParameteri(C,r.TEXTURE_WRAP_T,K[v.wrapT]),(C===r.TEXTURE_3D||C===r.TEXTURE_2D_ARRAY)&&r.texParameteri(C,r.TEXTURE_WRAP_R,K[v.wrapR]),r.texParameteri(C,r.TEXTURE_MAG_FILTER,se[v.magFilter]),r.texParameteri(C,r.TEXTURE_MIN_FILTER,se[v.minFilter]),v.compareFunction&&(r.texParameteri(C,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(C,r.TEXTURE_COMPARE_FUNC,te[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===At||v.minFilter!==ds&&v.minFilter!==ri||v.type===un&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");r.texParameterf(C,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Ie(C,v){let N=!1;C.__webglInit===void 0&&(C.__webglInit=!0,v.addEventListener("dispose",A));const j=v.source;let Z=u.get(j);Z===void 0&&(Z={},u.set(j,Z));const Y=B(v);if(Y!==C.__cacheKey){Z[Y]===void 0&&(Z[Y]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,N=!0),Z[Y].usedTimes++;const Ce=Z[C.__cacheKey];Ce!==void 0&&(Z[C.__cacheKey].usedTimes--,Ce.usedTimes===0&&M(v)),C.__cacheKey=Y,C.__webglTexture=Z[Y].texture}return N}function We(C,v,N){return Math.floor(Math.floor(C/N)/v)}function je(C,v,N,j){const Y=C.updateRanges;if(Y.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,v.width,v.height,N,j,v.data);else{Y.sort((re,ue)=>re.start-ue.start);let Ce=0;for(let re=1;re<Y.length;re++){const ue=Y[Ce],we=Y[re],Ae=ue.start+ue.count,he=We(we.start,v.width,4),Ge=We(ue.start,v.width,4);we.start<=Ae+1&&he===Ge&&We(we.start+we.count-1,v.width,4)===he?ue.count=Math.max(ue.count,we.start+we.count-ue.start):(++Ce,Y[Ce]=we)}Y.length=Ce+1;const ce=r.getParameter(r.UNPACK_ROW_LENGTH),Te=r.getParameter(r.UNPACK_SKIP_PIXELS),Ne=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,v.width);for(let re=0,ue=Y.length;re<ue;re++){const we=Y[re],Ae=Math.floor(we.start/4),he=Math.ceil(we.count/4),Ge=Ae%v.width,O=Math.floor(Ae/v.width),me=he,ae=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,Ge),r.pixelStorei(r.UNPACK_SKIP_ROWS,O),t.texSubImage2D(r.TEXTURE_2D,0,Ge,O,me,ae,N,j,v.data)}C.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,ce),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Te),r.pixelStorei(r.UNPACK_SKIP_ROWS,Ne)}}function $(C,v,N){let j=r.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(j=r.TEXTURE_2D_ARRAY),v.isData3DTexture&&(j=r.TEXTURE_3D);const Z=Ie(C,v),Y=v.source;t.bindTexture(j,C.__webglTexture,r.TEXTURE0+N);const Ce=n.get(Y);if(Y.version!==Ce.__version||Z===!0){t.activeTexture(r.TEXTURE0+N);const ce=$e.getPrimaries($e.workingColorSpace),Te=v.colorSpace===kn?null:$e.getPrimaries(v.colorSpace),Ne=v.colorSpace===kn||ce===Te?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);let re=_(v.image,!1,i.maxTextureSize);re=ge(v,re);const ue=s.convert(v.format,v.colorSpace),we=s.convert(v.type);let Ae=E(v.internalFormat,ue,we,v.colorSpace,v.isVideoTexture);oe(j,v);let he;const Ge=v.mipmaps,O=v.isVideoTexture!==!0,me=Ce.__version===void 0||Z===!0,ae=Y.dataReady,xe=b(v,re);if(v.isDepthTexture)Ae=y(v.format===oi,v.type),me&&(O?t.texStorage2D(r.TEXTURE_2D,1,Ae,re.width,re.height):t.texImage2D(r.TEXTURE_2D,0,Ae,re.width,re.height,0,ue,we,null));else if(v.isDataTexture)if(Ge.length>0){O&&me&&t.texStorage2D(r.TEXTURE_2D,xe,Ae,Ge[0].width,Ge[0].height);for(let ie=0,J=Ge.length;ie<J;ie++)he=Ge[ie],O?ae&&t.texSubImage2D(r.TEXTURE_2D,ie,0,0,he.width,he.height,ue,we,he.data):t.texImage2D(r.TEXTURE_2D,ie,Ae,he.width,he.height,0,ue,we,he.data);v.generateMipmaps=!1}else O?(me&&t.texStorage2D(r.TEXTURE_2D,xe,Ae,re.width,re.height),ae&&je(v,re,ue,we)):t.texImage2D(r.TEXTURE_2D,0,Ae,re.width,re.height,0,ue,we,re.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){O&&me&&t.texStorage3D(r.TEXTURE_2D_ARRAY,xe,Ae,Ge[0].width,Ge[0].height,re.depth);for(let ie=0,J=Ge.length;ie<J;ie++)if(he=Ge[ie],v.format!==nn)if(ue!==null)if(O){if(ae)if(v.layerUpdates.size>0){const le=qa(he.width,he.height,v.format,v.type);for(const Fe of v.layerUpdates){const at=he.data.subarray(Fe*le/he.data.BYTES_PER_ELEMENT,(Fe+1)*le/he.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ie,0,0,Fe,he.width,he.height,1,ue,at)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ie,0,0,0,he.width,he.height,re.depth,ue,he.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,ie,Ae,he.width,he.height,re.depth,0,he.data,0,0);else Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else O?ae&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,ie,0,0,0,he.width,he.height,re.depth,ue,we,he.data):t.texImage3D(r.TEXTURE_2D_ARRAY,ie,Ae,he.width,he.height,re.depth,0,ue,we,he.data)}else{O&&me&&t.texStorage2D(r.TEXTURE_2D,xe,Ae,Ge[0].width,Ge[0].height);for(let ie=0,J=Ge.length;ie<J;ie++)he=Ge[ie],v.format!==nn?ue!==null?O?ae&&t.compressedTexSubImage2D(r.TEXTURE_2D,ie,0,0,he.width,he.height,ue,he.data):t.compressedTexImage2D(r.TEXTURE_2D,ie,Ae,he.width,he.height,0,he.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):O?ae&&t.texSubImage2D(r.TEXTURE_2D,ie,0,0,he.width,he.height,ue,we,he.data):t.texImage2D(r.TEXTURE_2D,ie,Ae,he.width,he.height,0,ue,we,he.data)}else if(v.isDataArrayTexture)if(O){if(me&&t.texStorage3D(r.TEXTURE_2D_ARRAY,xe,Ae,re.width,re.height,re.depth),ae)if(v.layerUpdates.size>0){const ie=qa(re.width,re.height,v.format,v.type);for(const J of v.layerUpdates){const le=re.data.subarray(J*ie/re.data.BYTES_PER_ELEMENT,(J+1)*ie/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,J,re.width,re.height,1,ue,we,le)}v.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,ue,we,re.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Ae,re.width,re.height,re.depth,0,ue,we,re.data);else if(v.isData3DTexture)O?(me&&t.texStorage3D(r.TEXTURE_3D,xe,Ae,re.width,re.height,re.depth),ae&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,ue,we,re.data)):t.texImage3D(r.TEXTURE_3D,0,Ae,re.width,re.height,re.depth,0,ue,we,re.data);else if(v.isFramebufferTexture){if(me)if(O)t.texStorage2D(r.TEXTURE_2D,xe,Ae,re.width,re.height);else{let ie=re.width,J=re.height;for(let le=0;le<xe;le++)t.texImage2D(r.TEXTURE_2D,le,Ae,ie,J,0,ue,we,null),ie>>=1,J>>=1}}else if(Ge.length>0){if(O&&me){const ie=ee(Ge[0]);t.texStorage2D(r.TEXTURE_2D,xe,Ae,ie.width,ie.height)}for(let ie=0,J=Ge.length;ie<J;ie++)he=Ge[ie],O?ae&&t.texSubImage2D(r.TEXTURE_2D,ie,0,0,ue,we,he):t.texImage2D(r.TEXTURE_2D,ie,Ae,ue,we,he);v.generateMipmaps=!1}else if(O){if(me){const ie=ee(re);t.texStorage2D(r.TEXTURE_2D,xe,Ae,ie.width,ie.height)}ae&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ue,we,re)}else t.texImage2D(r.TEXTURE_2D,0,Ae,ue,we,re);m(v)&&f(j),Ce.__version=Y.version,v.onUpdate&&v.onUpdate(v)}C.__version=v.version}function Q(C,v,N){if(v.image.length!==6)return;const j=Ie(C,v),Z=v.source;t.bindTexture(r.TEXTURE_CUBE_MAP,C.__webglTexture,r.TEXTURE0+N);const Y=n.get(Z);if(Z.version!==Y.__version||j===!0){t.activeTexture(r.TEXTURE0+N);const Ce=$e.getPrimaries($e.workingColorSpace),ce=v.colorSpace===kn?null:$e.getPrimaries(v.colorSpace),Te=v.colorSpace===kn||Ce===ce?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);const Ne=v.isCompressedTexture||v.image[0].isCompressedTexture,re=v.image[0]&&v.image[0].isDataTexture,ue=[];for(let J=0;J<6;J++)!Ne&&!re?ue[J]=_(v.image[J],!0,i.maxCubemapSize):ue[J]=re?v.image[J].image:v.image[J],ue[J]=ge(v,ue[J]);const we=ue[0],Ae=s.convert(v.format,v.colorSpace),he=s.convert(v.type),Ge=E(v.internalFormat,Ae,he,v.colorSpace),O=v.isVideoTexture!==!0,me=Y.__version===void 0||j===!0,ae=Z.dataReady;let xe=b(v,we);oe(r.TEXTURE_CUBE_MAP,v);let ie;if(Ne){O&&me&&t.texStorage2D(r.TEXTURE_CUBE_MAP,xe,Ge,we.width,we.height);for(let J=0;J<6;J++){ie=ue[J].mipmaps;for(let le=0;le<ie.length;le++){const Fe=ie[le];v.format!==nn?Ae!==null?O?ae&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,le,0,0,Fe.width,Fe.height,Ae,Fe.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,le,Ge,Fe.width,Fe.height,0,Fe.data):Ue("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,le,0,0,Fe.width,Fe.height,Ae,he,Fe.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,le,Ge,Fe.width,Fe.height,0,Ae,he,Fe.data)}}}else{if(ie=v.mipmaps,O&&me){ie.length>0&&xe++;const J=ee(ue[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,xe,Ge,J.width,J.height)}for(let J=0;J<6;J++)if(re){O?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,ue[J].width,ue[J].height,Ae,he,ue[J].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Ge,ue[J].width,ue[J].height,0,Ae,he,ue[J].data);for(let le=0;le<ie.length;le++){const at=ie[le].image[J].image;O?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,le+1,0,0,at.width,at.height,Ae,he,at.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,le+1,Ge,at.width,at.height,0,Ae,he,at.data)}}else{O?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Ae,he,ue[J]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Ge,Ae,he,ue[J]);for(let le=0;le<ie.length;le++){const Fe=ie[le];O?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,le+1,0,0,Ae,he,Fe.image[J]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,le+1,Ge,Ae,he,Fe.image[J])}}}m(v)&&f(r.TEXTURE_CUBE_MAP),Y.__version=Z.version,v.onUpdate&&v.onUpdate(v)}C.__version=v.version}function Me(C,v,N,j,Z,Y){const Ce=s.convert(N.format,N.colorSpace),ce=s.convert(N.type),Te=E(N.internalFormat,Ce,ce,N.colorSpace),Ne=n.get(v),re=n.get(N);if(re.__renderTarget=v,!Ne.__hasExternalTextures){const ue=Math.max(1,v.width>>Y),we=Math.max(1,v.height>>Y);Z===r.TEXTURE_3D||Z===r.TEXTURE_2D_ARRAY?t.texImage3D(Z,Y,Te,ue,we,v.depth,0,Ce,ce,null):t.texImage2D(Z,Y,Te,ue,we,0,Ce,ce,null)}t.bindFramebuffer(r.FRAMEBUFFER,C),_e(v)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,j,Z,re.__webglTexture,0,D(v)):(Z===r.TEXTURE_2D||Z>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,j,Z,re.__webglTexture,Y),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Oe(C,v,N){if(r.bindRenderbuffer(r.RENDERBUFFER,C),v.depthBuffer){const j=v.depthTexture,Z=j&&j.isDepthTexture?j.type:null,Y=y(v.stencilBuffer,Z),Ce=v.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;_e(v)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,D(v),Y,v.width,v.height):N?r.renderbufferStorageMultisample(r.RENDERBUFFER,D(v),Y,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,Y,v.width,v.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Ce,r.RENDERBUFFER,C)}else{const j=v.textures;for(let Z=0;Z<j.length;Z++){const Y=j[Z],Ce=s.convert(Y.format,Y.colorSpace),ce=s.convert(Y.type),Te=E(Y.internalFormat,Ce,ce,Y.colorSpace);_e(v)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,D(v),Te,v.width,v.height):N?r.renderbufferStorageMultisample(r.RENDERBUFFER,D(v),Te,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,Te,v.width,v.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Se(C,v,N){const j=v.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(r.FRAMEBUFFER,C),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(v.depthTexture);if(Z.__renderTarget=v,(!Z.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),j){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,v.depthTexture.addEventListener("dispose",A)),Z.__webglTexture===void 0){Z.__webglTexture=r.createTexture(),t.bindTexture(r.TEXTURE_CUBE_MAP,Z.__webglTexture),oe(r.TEXTURE_CUBE_MAP,v.depthTexture);const Ne=s.convert(v.depthTexture.format),re=s.convert(v.depthTexture.type);let ue;v.depthTexture.format===Un?ue=r.DEPTH_COMPONENT24:v.depthTexture.format===oi&&(ue=r.DEPTH24_STENCIL8);for(let we=0;we<6;we++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,ue,v.width,v.height,0,Ne,re,null)}}else F(v.depthTexture,0);const Y=Z.__webglTexture,Ce=D(v),ce=j?r.TEXTURE_CUBE_MAP_POSITIVE_X+N:r.TEXTURE_2D,Te=v.depthTexture.format===oi?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(v.depthTexture.format===Un)_e(v)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Te,ce,Y,0,Ce):r.framebufferTexture2D(r.FRAMEBUFFER,Te,ce,Y,0);else if(v.depthTexture.format===oi)_e(v)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Te,ce,Y,0,Ce):r.framebufferTexture2D(r.FRAMEBUFFER,Te,ce,Y,0);else throw new Error("Unknown depthTexture format")}function Xe(C){const v=n.get(C),N=C.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==C.depthTexture){const j=C.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),j){const Z=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,j.removeEventListener("dispose",Z)};j.addEventListener("dispose",Z),v.__depthDisposeCallback=Z}v.__boundDepthTexture=j}if(C.depthTexture&&!v.__autoAllocateDepthBuffer)if(N)for(let j=0;j<6;j++)Se(v.__webglFramebuffer[j],C,j);else{const j=C.texture.mipmaps;j&&j.length>0?Se(v.__webglFramebuffer[0],C,0):Se(v.__webglFramebuffer,C,0)}else if(N){v.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[j]),v.__webglDepthbuffer[j]===void 0)v.__webglDepthbuffer[j]=r.createRenderbuffer(),Oe(v.__webglDepthbuffer[j],C,!1);else{const Z=C.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Y=v.__webglDepthbuffer[j];r.bindRenderbuffer(r.RENDERBUFFER,Y),r.framebufferRenderbuffer(r.FRAMEBUFFER,Z,r.RENDERBUFFER,Y)}}else{const j=C.texture.mipmaps;if(j&&j.length>0?t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=r.createRenderbuffer(),Oe(v.__webglDepthbuffer,C,!1);else{const Z=C.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Y=v.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,Y),r.framebufferRenderbuffer(r.FRAMEBUFFER,Z,r.RENDERBUFFER,Y)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function mt(C,v,N){const j=n.get(C);v!==void 0&&Me(j.__webglFramebuffer,C,C.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),N!==void 0&&Xe(C)}function qe(C){const v=C.texture,N=n.get(C),j=n.get(v);C.addEventListener("dispose",R);const Z=C.textures,Y=C.isWebGLCubeRenderTarget===!0,Ce=Z.length>1;if(Ce||(j.__webglTexture===void 0&&(j.__webglTexture=r.createTexture()),j.__version=v.version,o.memory.textures++),Y){N.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(v.mipmaps&&v.mipmaps.length>0){N.__webglFramebuffer[ce]=[];for(let Te=0;Te<v.mipmaps.length;Te++)N.__webglFramebuffer[ce][Te]=r.createFramebuffer()}else N.__webglFramebuffer[ce]=r.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){N.__webglFramebuffer=[];for(let ce=0;ce<v.mipmaps.length;ce++)N.__webglFramebuffer[ce]=r.createFramebuffer()}else N.__webglFramebuffer=r.createFramebuffer();if(Ce)for(let ce=0,Te=Z.length;ce<Te;ce++){const Ne=n.get(Z[ce]);Ne.__webglTexture===void 0&&(Ne.__webglTexture=r.createTexture(),o.memory.textures++)}if(C.samples>0&&_e(C)===!1){N.__webglMultisampledFramebuffer=r.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let ce=0;ce<Z.length;ce++){const Te=Z[ce];N.__webglColorRenderbuffer[ce]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,N.__webglColorRenderbuffer[ce]);const Ne=s.convert(Te.format,Te.colorSpace),re=s.convert(Te.type),ue=E(Te.internalFormat,Ne,re,Te.colorSpace,C.isXRRenderTarget===!0),we=D(C);r.renderbufferStorageMultisample(r.RENDERBUFFER,we,ue,C.width,C.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ce,r.RENDERBUFFER,N.__webglColorRenderbuffer[ce])}r.bindRenderbuffer(r.RENDERBUFFER,null),C.depthBuffer&&(N.__webglDepthRenderbuffer=r.createRenderbuffer(),Oe(N.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(Y){t.bindTexture(r.TEXTURE_CUBE_MAP,j.__webglTexture),oe(r.TEXTURE_CUBE_MAP,v);for(let ce=0;ce<6;ce++)if(v.mipmaps&&v.mipmaps.length>0)for(let Te=0;Te<v.mipmaps.length;Te++)Me(N.__webglFramebuffer[ce][Te],C,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Te);else Me(N.__webglFramebuffer[ce],C,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);m(v)&&f(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ce){for(let ce=0,Te=Z.length;ce<Te;ce++){const Ne=Z[ce],re=n.get(Ne);let ue=r.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ue=C.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ue,re.__webglTexture),oe(ue,Ne),Me(N.__webglFramebuffer,C,Ne,r.COLOR_ATTACHMENT0+ce,ue,0),m(Ne)&&f(ue)}t.unbindTexture()}else{let ce=r.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ce=C.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ce,j.__webglTexture),oe(ce,v),v.mipmaps&&v.mipmaps.length>0)for(let Te=0;Te<v.mipmaps.length;Te++)Me(N.__webglFramebuffer[Te],C,v,r.COLOR_ATTACHMENT0,ce,Te);else Me(N.__webglFramebuffer,C,v,r.COLOR_ATTACHMENT0,ce,0);m(v)&&f(ce),t.unbindTexture()}C.depthBuffer&&Xe(C)}function Je(C){const v=C.textures;for(let N=0,j=v.length;N<j;N++){const Z=v[N];if(m(Z)){const Y=x(C),Ce=n.get(Z).__webglTexture;t.bindTexture(Y,Ce),f(Y),t.unbindTexture()}}}const tt=[],Be=[];function ht(C){if(C.samples>0){if(_e(C)===!1){const v=C.textures,N=C.width,j=C.height;let Z=r.COLOR_BUFFER_BIT;const Y=C.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Ce=n.get(C),ce=v.length>1;if(ce)for(let Ne=0;Ne<v.length;Ne++)t.bindFramebuffer(r.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ne,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,Ce.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ne,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer);const Te=C.texture.mipmaps;Te&&Te.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let Ne=0;Ne<v.length;Ne++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(Z|=r.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(Z|=r.STENCIL_BUFFER_BIT)),ce){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ne]);const re=n.get(v[Ne]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,re,0)}r.blitFramebuffer(0,0,N,j,0,0,N,j,Z,r.NEAREST),l===!0&&(tt.length=0,Be.length=0,tt.push(r.COLOR_ATTACHMENT0+Ne),C.depthBuffer&&C.resolveDepthBuffer===!1&&(tt.push(Y),Be.push(Y),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Be)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,tt))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ce)for(let Ne=0;Ne<v.length;Ne++){t.bindFramebuffer(r.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ne,r.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ne]);const re=n.get(v[Ne]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,Ce.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ne,r.TEXTURE_2D,re,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const v=C.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[v])}}}function D(C){return Math.min(i.maxSamples,C.samples)}function _e(C){const v=n.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function ne(C){const v=o.render.frame;h.get(C)!==v&&(h.set(C,v),C.update())}function ge(C,v){const N=C.colorSpace,j=C.format,Z=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||N!==Li&&N!==kn&&($e.getTransfer(N)===st?(j!==nn||Z!==Xt)&&Ue("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ze("WebGLTextures: Unsupported texture color space:",N)),v}function ee(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=L,this.resetTextureUnits=V,this.setTexture2D=F,this.setTexture2DArray=I,this.setTexture3D=G,this.setTextureCube=X,this.rebindTextures=mt,this.setupRenderTarget=qe,this.updateRenderTargetMipmap=Je,this.updateMultisampleRenderTarget=ht,this.setupDepthRenderbuffer=Xe,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=_e,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function qm(r,e){function t(n,i=kn){let s;const o=$e.getTransfer(i);if(n===Xt)return r.UNSIGNED_BYTE;if(n===Xo)return r.UNSIGNED_SHORT_4_4_4_4;if(n===qo)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Yl)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===jl)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===Xl)return r.BYTE;if(n===ql)return r.SHORT;if(n===ts)return r.UNSIGNED_SHORT;if(n===Wo)return r.INT;if(n===gn)return r.UNSIGNED_INT;if(n===un)return r.FLOAT;if(n===Nn)return r.HALF_FLOAT;if(n===$l)return r.ALPHA;if(n===Kl)return r.RGB;if(n===nn)return r.RGBA;if(n===Un)return r.DEPTH_COMPONENT;if(n===oi)return r.DEPTH_STENCIL;if(n===Zl)return r.RED;if(n===Yo)return r.RED_INTEGER;if(n===Pi)return r.RG;if(n===jo)return r.RG_INTEGER;if(n===$o)return r.RGBA_INTEGER;if(n===Gs||n===Hs||n===ks||n===Ws)if(o===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Gs)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Hs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ks)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ws)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Gs)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Hs)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ks)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ws)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ao||n===lo||n===co||n===ho)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ao)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===lo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===co)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ho)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===uo||n===fo||n===po||n===mo||n===go||n===_o||n===xo)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===uo||n===fo)return o===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===po)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===mo)return s.COMPRESSED_R11_EAC;if(n===go)return s.COMPRESSED_SIGNED_R11_EAC;if(n===_o)return s.COMPRESSED_RG11_EAC;if(n===xo)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===vo||n===Mo||n===So||n===yo||n===Eo||n===bo||n===wo||n===To||n===Ao||n===Co||n===Ro||n===Po||n===Lo||n===Io)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===vo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Mo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===So)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===yo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Eo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===bo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===wo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===To)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ao)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Co)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ro)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Po)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Lo)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Io)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Do||n===No||n===Uo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Do)return o===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===No)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Uo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Fo||n===Oo||n===Bo||n===zo)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Fo)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Oo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Bo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===zo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ns?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const Ym=`
void main() {
